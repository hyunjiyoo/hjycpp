...
void DA::SetAt(int index, int val)
{
	if (index < 0 || index >= this->GetSize()) {
		...
		OutOfRangeException e(this, "Index out of bound", index);
		throw &e;
	}
	this->arr[index] = val;
}
...
int main() {
	...
	try
	{
		cout << "1000byte를 할당하려다가 실패했다고 가정." << endl;
		MemoryException e(NULL, "메모리 요청", 1000);
		throw &e;
	}
	catch (MyException* ep)
	{
